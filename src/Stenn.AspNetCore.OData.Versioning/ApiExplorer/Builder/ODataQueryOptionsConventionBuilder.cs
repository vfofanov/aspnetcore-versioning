...
namespace Microsoft.AspNet.OData.Builder
{
    ...
    /// </summary>
    public class ODataQueryOptionsConventionBuilder
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>
        ///     A <see cref="IDictionary{TKey,TValue}">collection</see> of
        ///     <see cref="IODataQueryOptionsConventionBuilder">controller convention builders</see>.
        /// </value>
        protected IDictionary<TypeInfo, IODataQueryOptionsConventionBuilder> ConventionBuilders { get; } =
        ...
        /// </summary>
        /// <value>
        ///     A <see cref="IList{T}">list</see> of
        ///     <see cref="IODataQueryOptionsConvention">OData query option conventions</see>.
        /// </value>
        ...
        ///     The <see cref="IEnumerable{T}">sequence</see> of <see cref="ApiDescription">API descriptions</see>
        ///     to apply configured conventions to.
        /// </param>
        /// <param name="queryOptionSettings">
        ///     The <see cref="ODataQueryOptionSettings">settings</see> used to apply OData query
        ///     option conventions.
        /// </param>
        ...
        private static bool IsODataLike(ApiDescription description)
        {
            ...
            {
                return Attribute.IsDefined(action.ControllerTypeInfo, typeof(EnableQueryAttribute), true);
            }
