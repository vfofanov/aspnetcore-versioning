...
namespace Microsoft.AspNet.OData
{
    ...
    public interface IModelTypeBuilder
    {
        ...
        /// <param name="clrType">
        ///     The CLR <see cref="Type">type</see> mapped to the
        ///     <paramref name="structuredType">structured type</paramref>.
        /// </param>
        ...
        /// <returns>
        ///     The original <paramref name="clrType">CLR type</paramref> or a new, dynamically generated substitute
        ...
        /// </returns>
        /// <remarks>
        ///     If a substitution is not required, the original <paramref name="clrType">CLR type</paramref> is returned. When a
        ///     substitution
        ///     <see cref="Type">type</see> is generated, it is performed only once per
        ///     <paramref name="apiVersion">API version</paramref>.
        /// </remarks>
        ...
        ///     The <see cref="ApiVersion">API version</see> of the <paramref name="action" /> to create the
        ///     parameter type for.
        /// </param>
        /// <param name="controllerName">
        ///     The name of the controller that defines the action. Necessary for generating unique
        ///     parameter types.
        /// </param>
        /// <returns>A strong <see cref="Type">type</see> definition for the OData <paramref name="action" /> parameters.</returns>
        /// <remarks>
        ///     <see cref="ODataActionParameters">OData action parameters</see> are modeled as a
        ///     <see cref="Dictionary{TKey,TValue}">dictionary</see>,
        ///     which is difficult to use effectively by documentation tools such as the API Explorer. The corresponding type is
        ///     generated only once per
        ///     <paramref name="apiVersion">API version</paramref>.
        /// </remarks>
