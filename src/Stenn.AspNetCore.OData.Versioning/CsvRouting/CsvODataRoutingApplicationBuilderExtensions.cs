...
namespace Stenn.AspNetCore.OData.Versioning.CsvRouting
{
    ...
    /// </summary>
    public static class CsvODataRoutingApplicationBuilderExtensions
    {
        /// <summary>
        /// Use <see cref="CsvODataRoutingMiddleware"/> route middleware using the given route pattern.
        ...
        public static IApplicationBuilder UseODataCsvDocs(this IApplicationBuilder app, string routePattern = "api-docs.csv", char csvDelimiter = ',')
        {
            if (app == null)
            {
            ...
            return app.UseMiddleware<CsvODataRoutingMiddleware>(routePattern, csvDelimiter);
        }
    }
}